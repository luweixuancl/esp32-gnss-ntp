...
#define FW_VER_PATCH         30
// Human mark on OLED home + boot splash (easy to eyeball: "v1.1.30").
#define FW_MARK              "v1.1.30"
// Full string for /status, /cfg, serial, OTA pages.
#define FW_VERSION           "1.1.30"
...
// v1.1.30: EN=1 with ISR symbol copy + non-DMA RX (v1.1.29 board: callbacks
// fired but symbols were 1×zero — DMA pointer stale after on_recv_done).
...
#define GPS_PPS_RMT_WINDOW_MS        50   // idle end-of-receive after last edge
