...
#define FW_VER_PATCH         39
// Human mark on OLED home + boot splash (easy to eyeball: "v1.1.39").
#define FW_MARK              "v1.1.39"
// Full string for /status, /cfg, serial, OTA pages.
#define FW_VERSION           "1.1.39"
...
// v1.1.36: EN=0 — board test CLOSED (zero symbols through DMA/RGB/rtc trials).
...
#define GPS_PPS_RMT_EN                0   // 0 = GPIO ISR only; 1 = IDF5 rmt_rx (shelved)
...
#define GPS_PPS_RMT_DMA               1   // when EN=1: prefer DMA (ISR still copies)
#endif
