...
> 固件：自 **v1.1.26** 落地；当前 tip **v1.1.43**（见 [CURRENT.md](CURRENT.md)）  
...
S3 v1.1.28 冒烟：用户确认壳温下降；13 min soak 中 Die 温约 37–40 °C。见 [board_test_s3_idf5_20260919.md](board_test_s3_idf5_20260919.md)。现行 tip **v1.1.43** 仍默认 160 MHz + modem sleep。
