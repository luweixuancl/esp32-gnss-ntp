...
> 更新日期：2026-09-21  
> **本分支 `cursor/holdover-options-a05e` = v1.1.43**（守时档扩展 + HLD 时钟环补样 + debug 进度）  
> **进行中**：守时精度长测 — [holdover_precision_v1143.md](holdover_precision_v1143.md)  
> 上一件：v1.1.42 Hold 5m / Refuse **PASS** — [fw_flash_v1142_result_20260921.md](fw_flash_v1142_result_20260921.md)  
> **`main` = v1.1.41**（v1.1.42 待合入）  
...
| GPS 异常守时档 | ✅ Refuse / 30s / 5m / **15m / 30m / 1h / 2h**（`ahold` 上限 7200） |
...
| 文档 | 用途 |
|---|---|
| [holdover_precision_v1143.md](holdover_precision_v1143.md) | **进行中**：守时精度长测任务书 |
