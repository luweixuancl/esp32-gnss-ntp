...
- Mark: **v1.1.40**（时钟环无参=一次全量下载；CSV 由 CLI）— [`docs/clock_trace.md`](../docs/clock_trace.md)
...
- Branch: `cursor/clock-psram-ring-a05e`（v1.1.40）— 现网 OTA PASS：[fw_flash_v1140_result_20260920.md](../docs/fw_flash_v1140_result_20260920.md)

## Verify

```text
wc -c firmware_esp32s3.bin   # 1100704
